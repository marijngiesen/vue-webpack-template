...
import HelloWorld from '@/components/HelloWorld.vue'{{#if_eq lintConfig "airbnb"}};{{/if_eq}}{{#if_eq runner "karma"}}
import { expect } from 'chai'{{#if_eq lintConfig "airbnb"}};{{/if_eq}}{{/if_eq}}
