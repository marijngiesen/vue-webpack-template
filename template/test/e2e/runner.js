...
{{#unless_eq projectType "lib"}}const webpackConfig = require('../../build/webpack.prod.conf'){{#if_eq lintConfig "airbnb"}};{{/if_eq}}
{{/unless_eq}}const devConfigPromise = require('../../build/webpack.dev.conf'){{#if_eq lintConfig "airbnb"}};{{/if_eq}}

let server{{#if_eq lintConfig "airbnb"}};{{/if_eq}}

devConfigPromise.then(devConfig => {
  const devServerOptions = devConfig.devServer{{#if_eq lintConfig "airbnb"}};{{/if_eq}}
  const compiler = webpack({{#if_eq projectType "lib"}}devConfig{{else}}webpackConfig{{/if_eq}}){{#if_eq lintConfig "airbnb"}};{{/if_eq}}
